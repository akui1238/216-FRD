...
def main():
    ...
    # img_path = "DRIVE/test/images/05_test.tif"
    # roi_mask_path = "DRIVE/test/1st_manual/05_test_mask.gif"

    # img_path = "/home/ydm/FRD-Net-pytorch-master/STARE/test/images1/im0235.ppm"
    # roi_mask_path = "/home/ydm/FRD-Net-pytorch-master/STARE/test/1st_labels_ah/im0235.ah.ppm"
    ...
    # create model
    model = FRD_Net(in_channels=3, num_classes=classes, base_c=64)
    ...
    val_dataset = STAREDataset('STARE', train=False,
                               transforms=SegmentationPresetEval(mean1, std1))
